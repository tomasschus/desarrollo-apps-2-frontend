...
describe("AdminSidebar", () => {
  ...
  it("renders all menu items with correct links", () => {
    ...
    expect(screen.getByRole("link", { name: /Lugares Culturales/ })).toHaveAttribute("href", "/admin/lugares");
    expect(screen.getByRole("link", { name: /Tickets/ })).toHaveAttribute("href", "/admin/tickets");
